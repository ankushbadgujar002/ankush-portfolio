...
export default function ContactSection() {
    ...
    return (
        <section
            id="contact"
            ref={sectionRef}
            className="relative py-24 md:py-32 bg-white dark:bg-zinc-900 overflow-hidden"
        >
            {/* Background glow */}
            <div className="absolute top-0 left-1/3 w-150 h-150 rounded-full
        bg-indigo-100/30 dark:bg-indigo-950/20 blur-[120px]" />

            <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-16">

                {/* Header */}
                <div ref={headingRef} className="mb-12 text-center">
                    <span className="text-xs uppercase tracking-widest text-indigo-500 dark:text-indigo-400">
                        Contact
                    </span>

                    <h2 className="mt-2 text-3xl md:text-4xl font-bold text-zinc-900 dark:text-white">
                    ...
                    <p className="mt-3 text-sm text-zinc-500 dark:text-zinc-400 max-w-xl mx-auto">
                        If you’re serious about building — reach out.
                    </p>
                </div>
              ...
              hover:border-indigo-400 dark:hover:border-indigo-600 transition"
                        >
                            <MailIcon />
                            <span className="text-sm text-zinc-700 dark:text-zinc-300">
                                ankushbadgujar002@gmail.com
                            </span>
                        </a>
                        ...
                        <div className="flex gap-4 pt-2">
                            ...
                            <a href="https://github.com/ankushbadgujar002" target="_blank"
                                className="p-3 rounded-lg bg-zinc-100 dark:bg-zinc-900
                hover:bg-zinc-200 dark:hover:bg-zinc-800 transition">
                                <GitHubIcon />
                            </a>

                            <a href="https://linkedin.com/in/ankush-badgujar-908904256" target="_blank"
                                className="p-3 rounded-lg bg-zinc-100 dark:bg-zinc-900
                hover:bg-zinc-200 dark:hover:bg-zinc-800 transition">
                                <LinkedInIcon />
                            </a>
